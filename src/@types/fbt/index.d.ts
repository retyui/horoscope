...
declare module 'fbt' {
  ...
  export const FbtParam: React.FC<FBT.ParamOptions & {
    name: string;
    children: React.ReactNode;
  }>;
  export const FbtPlural: React.FC<FBT.PluralOptions & {
    count: number;
    children: string;
  }>;
  export const FbtPronoun: React.FC<FBT.PronounOptions & {
    type: FBT.PronounType;
    gender: FBT.GenderConstValues;
  }>;
  export const FbtName: React.FC<Omit<FBT.ParamOptions, 'gender'> & {
    name: string;
